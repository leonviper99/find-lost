  ...
  <div class="page">
  	<div class="container">
		...
		if (isset($_SESSION['success'])): {
				      ...
				      alert('Urakoze, Suzuma sms na email wakiriye kuri contact watanze.');
				      </script>";
			  		  session_destroy();
			  		} endif
		?>
  		<div class="product-container">
  			<div class="product-content">
  				<div class="row">
					...
					$result_count = mysqli_query($db,"SELECT COUNT(*) As total_records FROM `product` WHERE type='byaratoraguwe' AND status='0'");
					$total_records = mysqli_fetch_array($result_count);
					$total_records = $total_records['total_records'];
				    $total_no_of_pages = ceil($total_records / $total_records_per_page);
					$second_last = $total_no_of_pages - 1; // total page minus 1

	  				$fetchproduct="SELECT * FROM product WHERE type='byaratoraguwe' AND status='0' order by id desc LIMIT $offset, $total_records_per_page";
