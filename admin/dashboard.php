          ...
          <div class="col-md-3 col-sm-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
                <h3>
                <?php 
                    echo $product->Get_success_product();
                 ?></h3>
                <!-- <h3>53<sup style="font-size: 20px">%</sup></h3> -->

                <p>Successeeded Product</p>
              </div>
              <div class="icon">
          ...
          <div class="col-md-3 col-sm-6">
            ...
            <div class="small-box bg-warning">
              <div class="inner">
                <h3>
                  <?php 
                    echo $visitors->Get_total_visitors();
                 ?>
                </h3>
          ...
          <div class="col-md-3 col-sm-6">
            ...
            <div class="small-box bg-danger">
              <div class="inner">
                <h3>
                  <?php 
                    echo $visitors->Get_today_visitors();
                 ?>
                </h3>

                <p>To day's Visitors</p>
              </div>
              <div class="icon">
