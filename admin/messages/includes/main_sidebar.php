      ...
      <div class="user-panel mt-1 pb-1 mb-1 d-flex">
        <div class="image">
          <?php if (!empty($row['admin_pic'])) {
            echo '<img src="../images/'.$row['admin_pic'].'" class="img-circle elevation-2" alt="Admin">';
          }
          else{
        ...
        <div class="info">
          ...
          <a href="#"><small><i class="fa fa-circle text-success"></i> Online</small></a>
        </div>
      </div>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="product.php" class="nav-link activ">
                  ...
                  <p>Product List</p>
                  <?php $fetch=$db->query("SELECT * FROM product");
                      echo '<span class="badge badge-info right">'.$fetch->num_rows.'</span>';
                  ?>
                </a>
              </li>
              </li>
              <li class="nav-item">
                <a href="lost_product.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Lost product</p>
                  <?php $fetch=$db->query("SELECT * FROM product WHERE type='byarabuze'");
                      echo '<span class="badge badge-danger right">'.$fetch->num_rows.'</span>';
                  ?>
                </a>
              </li>
              </li>
              <li class="nav-item">
                <a href="found_product.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Found Product</p>
                  <?php $fetch=$db->query("SELECT * FROM product WHERE type='byaratoraguwe'");
                      echo '<span class="badge badge-warning right">'.$fetch->num_rows.'</span>';
                  ?>
                </a>
              </li>
              <li class="nav-item">
