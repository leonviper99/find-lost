        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Sent msgs</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card-body p-0">
              ...
              <div class="table-responsive mailbox-messages">
                <table class="table table-hover table-striped">
                  <tbody>
                    <?php
                      $selectmsg=$db->query("SELECT * FROM sent_msgs");
                      while ($row=$selectmsg->fetch_assoc()) { ?>
                        <tr>
                          ...
                          <td class="mailbox-name"><?php echo($row['admin']); ?></td>
                          <td class="mailbox-name"><a href=""><?php echo($row['destination']); ?></a></td>
                          <td class="mailbox-subject"><b><?php echo($row['subject']); ?></b> - <?php echo($row['msg']); ?>                          </td>
