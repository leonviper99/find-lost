          ...
          <div class="card">
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php
                    $fetchproduct= $db->query("SELECT * FROM product inner join foundcontact on product.id=foundcontact.product_id  WHERE status='1' order by foundcontact.id desc");
                    while ($row=$fetchproduct->fetch_assoc()) {
                      $prdct=getCustomer($row['product_id']);
                      ...
                      <tr>
                        ...
                        <td><?php echo($row['found_name']); ?></td>
                        <td><?php echo($row['found_phone']); ?></td>
                        <td><?php echo($row['email']); ?></td>
                        <td><?php echo($row['advert_date']); ?></td>
                        <td><?php echo($row['date']); ?></td>
                        <td><span class="float-right"><?php echo($row['status']); ?></span></td>
                        <td>
                          <a class="btn btn-primary btn-sm" href="productview.php?productnumber=<?php echo($row['product_id']); ?>">
