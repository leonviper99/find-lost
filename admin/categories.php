 ...
 <!-- Navbar -->
  ...
  <div class="content-wrapper">
  	...
  	if (isset($_SESSION['categoryadded'])):
  		echo '<div class="text-center mt-2"><span px-5 py-2 class="alert alert-success ">New Category Is Added</span px-5 py-2></div>';
            ...
            <div class="card card-warning">
              ...
              <div class="card-body">
                ...
                <div class="text-center">                	
                  <a href="add_category.php" class="btn btn-secondary"><b>Add New Category</b></a>
                </div>
              </div><!-- /.card-body -->
            </div>
            <!-- /.nav-tabs-custom -->
