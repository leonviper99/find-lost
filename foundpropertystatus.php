...
<div class="page container bordered rounded py-2 my-2">
	<div class="property-check">
		<div class="property-check-header py-2">
			<h2><b>Suzuma niba ibyo washyize kururur'urubuga nyirabyo yarabonetse</b></h2>
		</div>
		<div class="property-check-content">
			<div class="row">
				<div class="col-lg-7">
					<?php
					if ($row['status'] == "1") {
						echo '<div class="alert alert-success"><h5><b>Ibyo washyize kururubuga byabonye nyirabyo</b></h5></div>';
					}
					else{
						echo '<div class="alert alert-danger"><h5><b>Ibyo washyize kururubuga nyirabyo ntaraboneka</b></h5></div>';
					}
					?>
						 	...
						 	<div class="mt-3 p-2">
						 		<div class="border rounded">
						 			<div class="found-header text-info text-center" style="border-bottom: 1px solid #C0C0C0;">
						 				<h6><strong>Ibyo washyize kururu rubuga nyirabyo yabonetse.Tunabashimira kubwicyizere cyanyu</strong></h6>
						 			</div>
						 			<div class="px-2">
						 				<small class="text-center text-danger"><b>Umwirondoro we:</b></small>
							 			<section>
							 				<b>Nyirabyo:</b>&nbsp<span><?php echo($res['found_name']) ?></span>
							 			</section>
							 			<section class="mt-1">
							 				<b>Nimero ye:</b>&nbsp<span><?php echo($res['found_phone']) ?></span>
							 			</section>
							 			<section class="mt-1">
							 				<b>Email:</b>&nbsp<span><?php echo($res['email']) ?></span>
							 			</section>
							 		</div>
							 		<div class="container my-2">
							 			<a href="checkfoundproperty.php?re_advert=advert" onclick="return confirm('Emeza ko Ushaka gusubiza itangazo kurubuga?')" class="btn btn-block btn-secondary"><b>Uramutse usanze uwatanze contact atariwe nyirabyo kanda hano bisubire kurubuga</b></a>
							 		</div>
						 		</div>
